...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CSSE4011_TMP36_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEARTBEAT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEARTBEAT_LOG_LEVEL, 3);
